...
//title of the page
echo "<head><title>Remove Earring</title></head>";
...
//
echo "<div class='container'><br><h1>Remove a earring:</h1>";
echo "<form action='target_remove_earring.php' method='post'>
 <br><select name='ID' class='form-control' required=true><option>Please choose an option below</option>";

$sql="SELECT ID, name, size from earings";
