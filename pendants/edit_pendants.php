...
//title of the page
echo "<head><title>Edit Pendants</title></head>";
...
echo "<div class='container'><br><h1>Edit existing pendants:</h1>";
echo "<form action='target_edit_pendants.php' method='post'>

	Earring to edit: <select name='PendantsID' class='form-control' required=true><option>Please choose an option below</option>";

	$sql="SELECT ID, name, amount FROM pendants";
